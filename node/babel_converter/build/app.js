...
var Stock = /*#__PURE__*/function (_EventEmitter) {
  _inherits(Stock, _EventEmitter);
...
var stock = new Stock('RIL', 2300);
stock.on('PriceChanged', function (arg) {
  console.log("The price of the stock ".concat(arg.symbol, " has changed ").concat(arg.adjustment, "%"));
});
stock.price = 2433;
